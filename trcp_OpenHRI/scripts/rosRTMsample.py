...
rosrtmsample_spec = ["implementation_id", "rosRTMsample", 
		 "type_name",         "rosRTMsample", 
		 "description",       "rosRTM", 
		 "version",           "1.0.0", 
...
# 
# 
class rosRTMsample(OpenRTM_aist.DataFlowComponentBase):
...
def rosRTMsampleInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=rosrtmsample_spec)
    manager.registerFactory(profile,
                            rosRTMsample,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    rosRTMsampleInit(manager)

    # Create a component
    comp = manager.createComponent("rosRTMsample")
